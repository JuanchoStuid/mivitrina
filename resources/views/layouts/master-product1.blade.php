...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/extras/slick/slick.css">
    <link rel="stylesheet" type="text/css" href="assets/extras/slick/slick-theme.css">
    ...
    <div class="page-header">
      <div class="page-header-inner">
        <div class="container">
          ...
          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
            <li class="page">Single Product</li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="info-panel">
              <h1 class="product-title">Distressed Denim T-Shirts</h1>
              <div class="comments">
              ...
              <div class="description">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate inventore accusantium harum obcaecati, enim voluptatem error architecto laudantium deserunt sit nisi sint molestias perspiciatis voluptates, sed eum eaque. Quos, aliquid! laudantium deserunt sit nisi sint molestias perspiciatis voluptates, sed eum eaque. Quos, aliquid!</p>
              </div>
              <div class="size">
                <h4>Size Options</h4>
                <span>S</span>
