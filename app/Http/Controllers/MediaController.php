...
class MediaController extends Controller
{
    ...
    public function index()
    {
        ...
        $medias = Media::all(['med_id', 'med_div_class', 'med_h3', 'med_video_audio']);

        return view('media', ['services'=>$services, 'portfolios'=>$portfolios, 'otherservices'=>$otherservices, 'progress'=>$progress, 'clients'=>$clients, 'testimonials'=>$testimonials, 'teams'=>$teams, 'blogs'=>$blogs, 'copiesrights'=>$copiesrights, 'coolsfacts'=>$coolsfacts, 'filters'=>$filters, 'logo'=>$logo, 'medias'=>$medias]);
    }
